...
let AverbacaoConsultaService = class AverbacaoConsultaService {
    ...
    averbacaoByIdEmpresa(id) {
        return this.http.get(`${_app_api__WEBPACK_IMPORTED_MODULE_4__["CONGIGA_API"]}/api/ReguaComunicacao/getConsultarAprovacaoEmpresa/${id}/`)
...
let EmpresaFilialService = class EmpresaFilialService {
    ...
    incluirEmpresaFilial(empresaFilial) {
        return this.http.post(`${_app_api__WEBPACK_IMPORTED_MODULE_4__["CONGIGA_API"]}/api/ReguaComunicacao/copiarEmpresaFilial`, JSON.stringify(empresaFilial), this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["retry"])(2), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
    }
    handleError(error) {
        let errorMessage = '';
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CONGIGA_API", function() { return CONGIGA_API; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _environments_environment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../environments/environment */ "./src/environments/environment.ts");


const CONGIGA_API = _environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].api;
...
module.exports = __webpack_require__(/*! /home/nilton/ConsigaMais/front-end/portal-backoffice/src/main.ts */"./src/main.ts");
